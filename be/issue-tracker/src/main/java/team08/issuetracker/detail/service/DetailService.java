...
//    private final LabelService labelService;
    ...
    public IssueDetailDto getIssueDetailResponse(long id) {
        ...
        List<AssigneeResponse> assigneeDto = issueService.getAssigneeDto(id);
        List<LabelSummaryDto> labelSummaryDto = issueService.getLabelSummaryDto(id);
//        List<LabelSummaryDto> labelSummaryDto = labelService.getLabelSummaryDto(id);
        ...
        return IssueDetailDto.from(issueSummaryDto, assigneeDto, labelSummaryDto, commentSummaryDto,
                milestoneSummaryDto);
    }
    // Mango
