	...
	return (
		<div className="component-border h-[40px] w-2/5 flex items-center dark:component-border--dark">
			...
			<div className="relative w-[80%] h-full ">
				<input
					className={`absolute top-0 h-full w-full ${textColor} rounded-r-xl pl-9 bg-grayscale.200 border-l-2 border-grayscale.300 dark:bg-grayscale.700 dark:component-border--dark focus:input-text--focus`}
					type="text"
				/>
