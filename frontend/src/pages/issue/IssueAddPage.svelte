...
<div class="flex flex-col w-full">
        ...
        <div id="content-area" class="flex gap-4 justify-between">
            ...
            <div class="flex flex-col w-full">
                ...
                <div class="flex flex-col content-input rounded-lg ">
                    <textarea placeholder="내용을 입력하세요" class="mb-1 w-full h-[250px] rounded-lg p-3 focus:bg-white focus:outline outline-neutral-500" bind:value={issueFormValues.content}></textarea>
    ...
    <div class="flex justify-end action-buttons">
        <button type="button" class="btn issue cancel cancel-button"
                on:click={onCancelCreateIssue}>✕ 작성 취소</button>
        <button type="button" class="btn issue create submit-button"
