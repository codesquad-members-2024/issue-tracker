...
<div class="label-form-edit-container animate-slidein">
    ...
    <div class="edit-title-container gap-3">
        <button class="edit-title-btn blue-border gap-2" on:click={onCloseEditModeLabel}>
                <span class="">
                    <i class="bi bi-x-lg"></i>
                </span>
            취소
        </button>
        <button class="edit-title-btn apply gap-2" on:click={onUpdateLabel} disabled={isSubmitLocked}>
